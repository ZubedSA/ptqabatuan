      ...
      <section className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-900 rounded-3xl md:-mt-32 relative z-20 p-8 md:p-12 shadow-2xl border border-gray-100 dark:border-gray-800">
            ...
            >
              {/* Splitting newlines and supporting simple arabic font heuristics if needed */}
              {article.content.split("\n").map((paragraph: string, idx: number) => {
                if (!paragraph.trim()) return <br key={idx} />;
                
                // Simple heuristic: if paragraph contains arabic letters, apply arabic font class
            ...
            <div className="mt-16 pt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <button 
                  ...
                  className="p-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300 rounded-full transition-colors"
                >
