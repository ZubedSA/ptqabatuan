    ...
    <div className="max-w-3xl mx-auto space-y-6 pb-12">
      <div className="flex items-center gap-4 border-b border-gray-200 pb-5">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Tambahkan kampanye donasi atau wakaf baru dengan foto dan target.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8 space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="Contoh: Pembebasan Lahan Asrama Santri Penghafal Al-Qur'an"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Jelaskan secara singkat tujuan penggalangan dana / wakaf ini serta pemanfaatannya..."
            />
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-gray-800 border-b border-gray-100 pb-2 flex items-center gap-2">
            <Calculator className="w-5 h-5 text-[#0a3822]" /> Target Dana & Saldo Masuk
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              />
              <p className="text-xs text-gray-500">Kosongkan jika donasi bersifat berkelanjutan tanpa target nominal.</p>
            </div>

            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-700">Saldo Awal / Offline (Rp)</label>
              <input
                type="number"
                min="0"
                ...
                placeholder="0"
              />
              <p className="text-xs text-gray-500">Dana yang sudah masuk sebelumnya (misal transfer langsung/tunai).</p>
            </div>
          </div>
        ...
        <div className="space-y-4">
              ...
              >
                {uploading ? (
                  ...
                  <>
                    ...
                    <span className="text-sm font-bold text-[#0a3822]">Pilih & Unggah Banyak Foto (Google Drive)</span>
                  </>
                )}
                <input
                  id={fileInputId}
          ...
          {images.length > 0 ? (
            ...
            <div className="p-6 border-2 border-dashed border-gray-200 rounded-xl text-center bg-gray-50/50">
              ...
              <p className="text-xs text-gray-500">Belum ada foto yang diunggah. Unggah satu atau beberapa foto untuk menarik minat para donatur.</p>
            </div>
          )}
        </div>
